...
// day before processing, because a ledger cannot learn of a Day 6 event before
// a Day 5 one. Keeping the transcription faithful and doing the reordering in
// the service means the discrepancy stays visible instead of being quietly
// tidied away in the data.
